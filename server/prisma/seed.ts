...
async function main() {
  ...
  const recipeIngredients = [
    ...
    { recipeId: r1.id, ingredientId: "azeite", qty: 15, unit: "ml" },
    { recipeId: r1.id, ingredientId: "limao", qty: 1, unit: "unid" },
    { recipeId: r1.id, ingredientId: "lemon-pepper", qty: 3, unit: "g" },
    ...
    { recipeId: r5.id, ingredientId: "tomate-cereja", qty: 2, unit: "unid" },
    ...
    { recipeId: r6.id, ingredientId: "tomate-cereja", qty: 6, unit: "unid" },
