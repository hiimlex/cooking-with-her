  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'radial-gradient(circle, #d6c9ff 0%, transparent 70%)' }}
      />
      <div
        aria-hidden
        className="absolute top-[250px] -left-20 w-[200px] h-[200px] rounded-full pointer-events-none opacity-50"
        style={{ background: 'radial-gradient(circle, #ffd9d9 0%, transparent 70%)' }}
      />

      <div className="flex-1" />

      <div className="relative" style={{ animation: shake ? 'shake 0.4s' : undefined }}>
        ...
        <div className="bg-card rounded-[22px] p-[22px]">
          ...
          <div className="text-[13px] text-muted mb-3 leading-[1.45]">
            Type our secret word to get in. Hint: the fluffy one.
          </div>
